...
if ("{popclip urls}" contains "www") or ("{popclip urls}" contains "http") then
	display notification " URL detected" with title "{popclip browser url}" sound name "/System/Library/Sounds/Pop.aiff"
	tell application "Google Chrome"
		activate
		set targetURL to "{popclip browser url}"
		...
		set targetURL to "https://datachart.surge.sh/#/dataview"
		set the URL of the last tab of the last window to targetURL
		delay 2
		tell application "System Events"
			keystroke tab
		...
		tell application "Terminal"
			...
			do script "cd $HOME/Desktop/SCC/charted-master" in theTab
			do script "npm start" in theTab
		end tell
		delay 10
		tell application "Google Chrome"
			activate
			set myTab to make new tab at end of tabs of window 1
			set URL of myTab to "localhost:3000"
			delay 2
...
tell application "TextWrangler"
	...
	save doc1 to file "Macintosh HD:Users:Sourabh:Desktop:temp.txt"
	quit
end tell
delay 1
